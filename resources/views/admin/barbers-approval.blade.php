    ...
    <div class="flex flex-wrap items-center justify-between gap-3">
        ...
        <div>
            ...
            <flux:text class="mt-1">
                Review, approve, or reject barber applications in the system.
            </flux:text>
        </div>
                            ...
                            <flux:table.row>
                                ...
                                <flux:table.cell>
                                    ...
                                    <div class="flex gap-3">
                                        ...
                                        <form method="POST" action="{{ route('admin.barbers.approve', $barber) }}">
                                            @csrf
                                            @method('PATCH')
                                        ...
                                        <form method="POST" action="{{ route('admin.barbers.reject', $barber) }}" 
