<x-app-layout>
        ...
        <div>
            ...
            <flux:text class="mt-1">
                Choose a service, pick an open slot, and keep your bookings organized.
            </flux:text>
        </div>
            ...
            <flux:card class="p-6 rounded-3xl">
                ...
                <div class="flex flex-wrap items-center justify-between gap-3">
                    <div>
                        ...
                        <flux:text class="mt-1">
                            Pick a date and choose from the available slots below.
                        </flux:text>
                    </div>
                </div>
                ...
                <div class="mt-6">
                    ...
                    <flux:text class="text-xs font-semibold uppercase tracking-[0.2em] text-zinc-500">
                        Available slots
                    </flux:text>
                    ...
                    <div class="mt-4 grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
                        ...
                        @forelse ($availableSlots as $slot)
                            ...
                            <form method="POST" action="{{ route('appointments.store') }}">
                                ...
                                <flux:card class="p-4">
                                    ...
                                    <flux:text class="text-xs font-semibold uppercase tracking-wider text-zinc-500">
                                        Slot
                                    </flux:text>
                                    ...
                                    <flux:button type="submit" variant="primary" class="mt-4 w-full">
                                        Book this slot
                                    </flux:button>
                        ...
                        @empty
                            ...
                            <div class="col-span-3">
                                <flux:card class="p-6 text-sm text-zinc-500">
                                    No open slots were found for the selected service and date.
                                </flux:card>
                            </div>
                    ...
                    <div class="mt-4 space-y-3">
                        ...
                        @forelse ($waitlistEntries as $entry)
                            ...
                            <flux:card class="p-4">
                                ...
                                <flux:text class="text-sm text-zinc-500">
                                    Preferred:
                                    {{ $entry->preferred_date?->format('M d, Y') ?? 'Any time' }}
                                    {{ $entry->preferred_time ? \Carbon\Carbon::parse($entry->preferred_time)->format('g:i A') : '' }}
                                </flux:text>
